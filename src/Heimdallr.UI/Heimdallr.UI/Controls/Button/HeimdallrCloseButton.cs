...
public class HeimdallrCloseButton : Button
{
  #region 종속성 생성저
  static HeimdallrCloseButton()
  {
    DefaultStyleKeyProperty.OverrideMetadata(typeof(HeimdallrCloseButton), new FrameworkPropertyMetadata(typeof(HeimdallrCloseButton)));
  }

  public HeimdallrCloseButton()
  {
    ToolTipOpening += HeimdallrCloseButton_ToolTipOpening;
  }
  #endregion

  #region HeimdallrCloseButton_ToolTipOpening 이벤트
  private void HeimdallrCloseButton_ToolTipOpening(object sender, ToolTipEventArgs e)
  {
  ...
  public static readonly DependencyProperty FillProperty = DependencyProperty.Register(nameof(Fill), typeof(Brush),
        typeof(HeimdallrCloseButton), new PropertyMetadata(Brushes.Gray));
  #endregion
  ...
  public static readonly DependencyProperty IconSizeProperty = DependencyProperty.Register(nameof(IconSize), typeof(double),
          typeof(HeimdallrCloseButton), new PropertyMetadata(25.0));
  #endregion
