...
public class HeimdallrSwitchCheckBox : CheckBox
{
  ...
  public HeimdallrSwitchCheckBox()
  {
    ToolTipOpening += HeimdallrSwitchCheckBox_ToolTipOpening;
  }
  #endregion

  #region HeimdallrSwitchCheckBox_ToolTipOpening 이벤트
  private void HeimdallrSwitchCheckBox_ToolTipOpening(object sender, ToolTipEventArgs e)
  {
