...
public class HeimdallrSlider : Slider
{
  ...
  public HeimdallrSlider()
  {
    ToolTipOpening += HeimdallrSlider_ToolTipOpening;
  }
  #endregion

  #region HeimdallrSlider_ToolTipOpening 이벤트
  private void HeimdallrSlider_ToolTipOpening(object sender, ToolTipEventArgs e)
  {
